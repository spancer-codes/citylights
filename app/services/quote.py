...
def generate_quote_file(payload: dict, quote_number: str) -> str:
    ...
    ws["A2"] = f"Quote Number: {quote_number}"
    ws["A3"] = f"Date: {payload['date_created']}"
    ws["A4"] = f"Valid Until: {payload['valid_until']}"
    ...
    ws["E6"] = "Quotation To"
    ws["E6"].font = font 
    ws["E7"] = payload['client_name']
    ws["E8"] = payload['client_address']
    ws["E9"] = payload['client_city']
    ...
    excel_path = f"generated_quotes/{quote_number}.xlsx"
